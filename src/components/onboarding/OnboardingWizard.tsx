...
import { BookOpen, ClipboardList, Users, UserPlus, ChevronRight, CheckCircle2 } from 'lucide-react';
...
export function useOnboardingProgress(props: Props) {
  const { lessonsCount, examsCount, studentsCount = 0, teachersCount = 0 } = props;
  const steps = [
    { done: lessonsCount > 0 },
    { done: examsCount > 0 },
  ...
  return { completedCount, totalSteps, progress, allDone };
}
