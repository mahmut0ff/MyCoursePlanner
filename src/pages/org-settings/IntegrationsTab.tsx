      ...
      <div className={`bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-6 space-y-4 ${!hasAccess ? 'opacity-50 pointer-events-none filter blur-[1px]' : ''}`}>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-semibold text-slate-900 dark:text-white">Глобальные Telegram-уведомления</h3>
              <p className="text-sm text-slate-500 dark:text-slate-400">
                В платформе используется единый централизованный бот <b>@planula_bot</b>. 
                Вам больше не требуется подключать собственный токен. Все уведомления работают автоматически для всех организаций и студентов.
              </p>
            </div>
          </div>
        </div>
