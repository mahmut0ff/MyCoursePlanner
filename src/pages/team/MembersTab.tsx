        ...
        <>
          ...
          <div className="fixed inset-y-0 right-0 w-full max-w-xl bg-white dark:bg-slate-900 z-50 shadow-2xl flex flex-col animate-[slideIn_.2s_ease]">
            ...
            <div className="flex-1 overflow-y-auto px-5 py-4 space-y-4">
              {/* Наборы и матрица правят один и тот же набор прав — см. AccessPresets. */}
              <AccessPresets
                active={p => presetActive(ovSet, p)}
                onToggle={p => setOvSet(prev => togglePreset(prev, p))}
              />
